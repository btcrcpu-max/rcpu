...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *rcpu-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *rcpu-qt* and *bitcoin-gui* executables |
...
| *libbitcoin_node*        | P2P and RPC server functionality used by *rcpud* and *rcpu-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *rcpud* and *bitcoin-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *bitcoin-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *rcpud* and *rcpu-qt* executables. |
...
rcpu-cli[rcpu-cli]-->libbitcoin_cli;

rcpud[rcpud]-->libbitcoin_node;
rcpud[rcpud]-->libbitcoin_wallet;

rcpu-qt[rcpu-qt]-->libbitcoin_node;
rcpu-qt[rcpu-qt]-->libbitcoinqt;
rcpu-qt[rcpu-qt]-->libbitcoin_wallet;
...
class rcpu-qt,rcpud,rcpu-cli,bitcoin-wallet bold
```
</td></tr><tr><td>
