...
This guide describes how to build rcpud, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run rcpud or the GUI.
