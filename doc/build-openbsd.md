...
This guide describes how to build rcpud, command-line utilities, and GUI on OpenBSD.
...
It is not necessary to build wallet functionality to run either `rcpud` or `rcpu-qt`.
