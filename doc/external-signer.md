...
```sh
$ rcpu-cli createwallet "hww" true true "" true true true
```
...
```sh
$ rcpu-cli -rpcwallet=<wallet> getnewaddress
$ rcpu-cli -rpcwallet=<wallet> walletdisplayaddress <address>
```
...
```sh
$ rcpu-cli -rpcwallet=<wallet> sendtoaddress <address> <amount>
```
