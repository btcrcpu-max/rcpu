...
```
RCPU version v2.x.x-narnia-core-27.0.0
              |        |            |
...
RCPU is supported and tested on operating systems using the Linux kernel and Windows 11.
RCPU should also work on most other Unix-like systems but is not as frequently tested
on them.  It is not recommended to use RCPU on unsupported systems.
...
- RCPU upgraded and rebased on Bitcoin Core 27.0. See a list of changes in the [Bitcoin Release Notes](https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-27.0.md).
- Checkpoint added
