...
debug log about your I2P configuration and connections. Run `rcpu-cli help
...
`rcpu-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `rcpu-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `rcpu-cli getpeerinfo`).

You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `rcpu-cli help getnodeaddresses` for details.
