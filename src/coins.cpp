...
void CCoinsViewCache::AddCoin(const COutPoint &outpoint, Coin&& coin, bool possible_overwrite) {
    ...
    TRACE5(utxocache, add,
           ...
           (int64_t)(it->second.coin.out.nValue.IsExplicit() ? it->second.coin.out.nValue.GetAmount() : -1),
...
static const size_t MIN_TRANSACTION_OUTPUT_WEIGHT = WITNESS_SCALE_FACTOR * [] {
    SizeComputer sc;
    CTxOut().Serialize(sc, false);
    return sc.size();
}();
