...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        "validateaddress",
        // !RCPU
        "\nReturn information about the given RCPU address.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The RCPU address to validate"},
        },
        // !RCPU END
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                // !RCPU
                {RPCResult::Type::STR, "address", /*optional=*/true, "The RCPU address validated"},
                // !RCPU END
