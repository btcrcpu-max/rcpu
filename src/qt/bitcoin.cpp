...
int GuiMain(int argc, char* argv[])
{
    ...
    // !RCPU: apply dark theme to the entire application
    {
        qApp->setStyleSheet(QString(
            ...
            "QComboBox QAbstractItemView { background-color: %3; color: %2; border: 1px solid %4; selection-background-color: %4; }"
            "QListView, QTableView, QTreeView { background-color: %3; color: %2; border: 1px solid %4; alternate-background-color: %1; }"
            "QTableView::item:selected, QListView::item:selected { background-color: %4; color: %2; }"
