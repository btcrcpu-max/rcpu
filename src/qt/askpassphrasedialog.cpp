...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 // !RCPU
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR RCPU</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                 // !RCPU END
        ...
        if(retval == QMessageBox::Yes)
        {
            if(newpass1 == newpass2)
            {
                ...
                // !RCPU
                "your RCPU from being stolen by malware infecting your computer.");
                // !RCPU END
                if (m_passphrase_out) {
