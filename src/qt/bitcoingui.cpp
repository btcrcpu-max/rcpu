    ...
    m_network_style(networkStyle)
{
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #dbeafe; border: 1px solid #93c5fd; border-radius: 7px; padding: 1px; text-align: center; color: #1e293b; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #2563eb, stop: 1 #60a5fa); border-radius: 7px; margin: 0px; }");
    }
