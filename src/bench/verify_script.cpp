...
static void VerifyScriptBench(benchmark::Bench& bench)
{
    ...
    key.Sign(SignatureHash(witScriptPubkey, txSpend, 0, SIGHASH_ALL, txCredit.vout[0].nValue.GetAmount(), SigVersion::WITNESS_V0), witness.stack.back());
    ...
    bench.run([&] {
        ...
        bool success = VerifyScript(
            ...
            flags,
            MutableTransactionSignatureChecker(&txSpend, 0, txCredit.vout[0].nValue.GetAmount(), MissingDataBehavior::ASSERT_FAIL),
            &err);
        ...
        int csuccess = bitcoinconsensus_verify_script_with_amount(
            ...
            txCredit.vout[0].nValue.GetAmount(),
