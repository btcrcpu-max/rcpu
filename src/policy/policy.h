...
/** Default for -suspiciousreorgdepth, number of blocks (0 = disabled) */
static constexpr unsigned int DEFAULT_SUSPICIOUS_REORG_DEPTH = 0;
// !RCPU END
/**
...
static constexpr decltype(CTransaction::nVersion) TX_MAX_STANDARD_VERSION{CT_VERSION}; // RCPU: allow CT (v3) transactions
