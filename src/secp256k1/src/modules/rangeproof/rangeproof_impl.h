...
SECP256K1_INLINE static int secp256k1_rangeproof_genrand(const secp256k1_sha256 *hash_ctx, secp256k1_scalar *sec, secp256k1_scalar *s, unsigned char *message,
...
SECP256K1_INLINE static int secp256k1_rangeproof_sign_impl(const secp256k1_sha256 *hash_ctx, const secp256k1_ecmult_gen_context* ecmult_gen_ctx,
...
SECP256K1_INLINE static int secp256k1_rangeproof_rewind_inner(const secp256k1_sha256 *hash_ctx, secp256k1_scalar *blind, uint64_t *v,
...
SECP256K1_INLINE static int secp256k1_rangeproof_verify_impl(const secp256k1_sha256 *hash_ctx, const secp256k1_ecmult_gen_context* ecmult_gen_ctx,
