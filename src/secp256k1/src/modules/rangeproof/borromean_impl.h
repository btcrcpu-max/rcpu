...
SECP256K1_INLINE static void secp256k1_borromean_hash(const secp256k1_sha256 *hash_ctx, unsigned char *hash, const unsigned char *m, size_t mlen, const unsigned char *e, size_t elen,
 ...
 */
int secp256k1_borromean_verify(const secp256k1_sha256 *hash_ctx, secp256k1_scalar *evalues, const unsigned char *e0,
...
int secp256k1_borromean_sign(const secp256k1_sha256 *hash_ctx, const secp256k1_ecmult_gen_context *ecmult_gen_ctx,
