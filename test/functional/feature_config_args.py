...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        # !RCPU
        with open(self.nodes[0].datadir_path / 'rcpu.conf', 'a', encoding='utf-8') as conf:
        # !RCPU END
    ...
    def test_config_file_log(self):
        ...
        # !RCPU
        conf_path = default_datadir / 'rcpu.conf'
        # !RCPU END
    ...
    def test_ignored_conf(self):
        ...
        node.assert_start_raises_init_error([f"-conf={temp_conf.name}"], re.escape(
            # !RCPU
            f'Error: Data directory "{node.datadir_path}" contains a "rcpu.conf" file which is ignored, because a '
            # !RCPU END
        ...
        # error.
        # !RCPU
        self.start_node(0, [f'-conf={node.datadir_path}/rcpu.conf'])
        # !RCPU END
        self.stop_node(0)
    ...
    def test_ignored_default_conf(self):
        ...
        node = self.nodes[0]
        # !RCPU
        (default_datadir / 'rcpu.conf').write_text(f"datadir={node.datadir_path}\n")
        # !RCPU END
        ...
        node.assert_start_raises_init_error([], re.escape(
            # !RCPU
            f'Error: Data directory "{node.datadir_path}" contains a "rcpu.conf" file which is ignored, because a '
            f'different configuration file "{default_datadir}/rcpu.conf" from data directory "{default_datadir}" '
            # !RCPU END
    ...
    def test_acceptstalefeeestimates_arg_support(self):
        ...
        # !RCPU
        conf_file = self.nodes[0].datadir_path / 'rcpu.conf'
        # !RCPU END
        #! RCPU
    ...
    def run_test(self):
        ...
        # !RCPU
        conf_file = default_data_dir / 'rcpu.conf'
        # !RCPU END
