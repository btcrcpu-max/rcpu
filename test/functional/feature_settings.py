...
class SettingsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # !RCPU
        conf = node.datadir_path / 'rcpu.conf'
        # !RCPU END

        # Assert default settings file was created
        self.stop_node(0)
        # !RCPU
        default_settings = {"_warning_": "This file is automatically generated and updated by RCPU. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
        # !RCPU END
