...
complete --command rcpud --no-files

# Extract options
function __fish_rcpud_get_options
...
complete \
    --command rcpud \
    --arguments "(__fish_rcpud_get_options --nofiles)"
