...
Generates a rcpu.conf file in `share/examples/` by parsing the output from `rcpud --help`. This script is run during the
release process to include a rcpu.conf with the release binaries and can also be run by users to generate a file locally.
