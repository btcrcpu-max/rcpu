...
BITCOIND=${BITCOIND:-$BINDIR/rcpud}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/rcpu.conf}
...
then
  ...
  echo -e "To safely generate a rcpu.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example rcpu.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-rcpu-conf.sh.
##
...
# parse the output from rcpud --help
